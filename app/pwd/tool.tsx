      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-white">
          ...
          <p className="text-blue-100">
            ...
            无需记忆乱码，记住口令即可。
            <br />
            本方案只用于临时生成，并非<b>最佳方案</b>，推荐使用<b>密码管理和同步工具</b>来管理和保存你的密码。
            当前主流浏览器（Firefox/Chrome/Edge 等）和操作系统（如 MacOS, Android, HarmonyOS 等）都有系统自带的密码填充功能，
            推荐使用<b>浏览器的密码管理和同步</b>功能，只需登录账号即可跨系统同步。
            <br />
